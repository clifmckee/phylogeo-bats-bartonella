...
allnames<-c("Myotis daubentonii","Myotis mystacinus","Nyctalus noctula","Myotis myotis",
            "Eptesicus nilssonii","Pipistrellus pygmaeus","Myotis riparius",
            "Myotis brandtii","Tylonycteris pachypus","Myotis nattereri","Corynorhinus townsendii",
            "Rhinolophus pearsonii","Rhinolophus fumigatus","Rousettus aegyptiacus",
            ...
            "Noctilio leporinus","Pteronotus davyi","Pteronotus personatus","Miniopterus fraterculus",
            "Miniopterus schreibersii","Triaenops persicus","Hipposideros gigas",
            "Hipposideros pomona","Hipposideros larvatus","Megaderma lyra",
...
source("C:/Users/newUser/Desktop/Bat_polygons_alt.R")
...
write.csv(overlapmatrix,file="C:/Users/Clif McKee/Desktop/trees3/overlap_alt.csv")
...
# Output matrix is sent to Excel sheet
write.csv(areamatrix,file="C:/Users/Clif McKee/Desktop/trees3/overlaparea_alt.csv")
